            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <div class="btn-group ml-2" role="group">
                        ...
                        <a href="notification?action=list&filter=read" class="btn btn-${param.filter == 'read' ? 'primary' : 'outline-primary'}">Đã đọc</a>
                    </div>
                    <div class="btn-group ml-2" role="group">
<!--                        <a href="notification?action=list&sort=newest${param.filter == 'unread' ? '&filter=unread' : ''}" class="btn btn-${empty sort || sort == 'newest' ? 'primary' : 'outline-primary'}">Mới→Cũ</a>-->
                        <a href="notification?action=list&sort=oldest${param.filter == 'unread' ? '&filter=unread' : ''}" class="btn btn-${sort == 'oldest' ? 'primary' : 'outline-primary'}">Cũ/Mới</a>
                    </div>
                </div>
            </div>
